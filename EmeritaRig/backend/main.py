...
from .auth import SECRET_KEY, ALGORITHM, get_password_hash, get_current_user, get_db, oauth2_scheme
...
SUCCESS_URL = os.getenv("SUCCESS_URL", "https://your-netlify-site.netlify.app/dashboard?payment=success")
CANCEL_URL = os.getenv("CANCEL_URL", "https://your-netlify-site.netlify.app/dashboard?payment=cancelled")
...
if __name__ == "__main__":
    ...
    if ssl_cert_path and ssl_key_path:
        uvicorn.run(app, host=host, port=port, reload=reload, ssl_certfile=ssl_cert_path, ssl_keyfile=ssl_key_path)
    else:
